...
[![prod](https://img.shields.io/github/actions/workflow/status/logfoxai/cli/release.yml?branch=main&label=prod)](https://github.com/logfoxai/cli/actions/workflows/release.yml)
[![next](https://img.shields.io/github/actions/workflow/status/logfoxai/cli/release.yml?branch=next&label=next)](https://github.com/logfoxai/cli/actions/workflows/release.yml)
