...
[![prime](https://img.shields.io/github/actions/workflow/status/logfoxai/cli/release.yml?branch=main&label=prime)](https://github.com/logfoxai/cli/actions/workflows/release.yml)
[![prod](https://img.shields.io/github/actions/workflow/status/logfoxai/cli/release.yml?branch=prod&label=prod)](https://github.com/logfoxai/cli/actions/workflows/release.yml)
